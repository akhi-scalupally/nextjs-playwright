...
const Navbar = () => {
  ...
  return (
    <div className="md:mx-20 mt-1 px-1 sm:my-1 flex justify-between" data-testid="navbar">
      ...
      <div className="flex gap-4 items-center">
        <Link href="/address" data-testid="address-link" className="text-lightGray hover:text-primary">
          Address
        </Link>
        <svg
          onClick={notify}
